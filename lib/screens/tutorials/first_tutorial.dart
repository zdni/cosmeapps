      ...
      body: Column(
        children: [
              ...
              children: [
                Container(
                  ...
                  child: const Center(
                    child: TextBodoAmat(
                      20.0,
                      'Nah beauty peoples, kita sudah tau bahan apa saja yang dilarang dalam kosmetik dan bahayanya apabila digunakan.',
                      TextAlign.center,
                    Colors.white
                    ),
                  ),
                ...
                Container(
                  ...
                  child: const Center(
                    child: TextBodoAmat(
                      20.0,
                      'Terus bagaimana sih cara kita untuk memilih kosmetik yang aman untuk kita?',
                      TextAlign.center,
                    Colors.white
                    ),
                  ),
          ...
          SizedBox(
            ...
            child: Image.asset(
              'assets/images/section-7/7-2.webp',
